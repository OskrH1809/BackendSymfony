...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=ServiciosContratados::class, mappedBy="user")
     */
    private $contratedServices;

    /**
     * @ORM\OneToMany(targetEntity=DataUser::class, mappedBy="user")
     */
    private $dataUsers;
...
//        $roles[] = 'ROLE_USER';
    ...
    public function removeContratedService(ServiciosContratados $contratedService): self
    {
        if ($this->contratedServices->removeElement($contratedService)) {
            ...
            if ($contratedService->getUser() === $this) {
                $contratedService->setUser(null);
            }
        }
